...
export function StructurePanel({ symbol, timeframe, candles, analysis, signals, settings, lastUpdated, now, activity }: {
  symbol: MarketSymbol;
  ...
  return (
    <aside data-testid="rtr-structure-panel" className="rounded-xl border border-[#263541] bg-[#121b23] p-4">
      ...
      <div className="mt-3 rounded-lg border border-[#263b42] bg-[#0e171e] p-3 text-[9px]">
        ...
        <div className="mt-2 border-t border-[#22303a] pt-2 text-[#657781]">Last data update: {clock(lastUpdated)} · Next analysis: {countdown(secondsToClose)}</div>
      </div>
